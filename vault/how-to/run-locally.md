...
steps:
  - name: Запуск сервера
    description: Запустите локальный PaperMC сервер с плагином
    command: ./gradlew runServer
  - name: Подключение к серверу
    description: Откройте Minecraft и подключитесь к localhost:25565
  - name: Тестирование
    description: Проверьте работу плагина в игре
  - name: Остановка
    description: Введите stop в консоли сервера
---
