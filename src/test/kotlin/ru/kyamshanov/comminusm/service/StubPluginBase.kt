...
abstract class StubPluginBase : Plugin {
    @Deprecated("Part of deprecated Plugin interface", ReplaceWith(""))
    ...
    override fun getPluginMeta(): PluginMeta = throw UnsupportedOperationException()
    ...
    override fun getLifecycleManager(): LifecycleEventManager<Plugin> = throw UnsupportedOperationException()
