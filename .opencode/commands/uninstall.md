...
Where `aequicor/ai-agent-kit` is the GitHub `<user>/<repo>` slug of the ai-agent-kit installation source. You can find it in `opencode.json` or in the URL the original `setup.md` was fetched from.
