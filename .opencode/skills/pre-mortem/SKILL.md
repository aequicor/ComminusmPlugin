...
**Purpose:** Lightweight pre-execute risk pass. Optional — invoke on demand for non-trivial features when @Main / user judges it useful, mandatory for critical-lane tasks. Forces an "imagine it failed in production — what was the cause?" lens before any code is written.
