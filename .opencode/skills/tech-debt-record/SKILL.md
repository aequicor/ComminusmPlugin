...
---
## Skill: tech-debt-record

**Purpose:** Record a non-critical code smell, duplication, warning, or deprecation as a tech-debt entry in the vault for later batch fixing via /kit-techdebt.
