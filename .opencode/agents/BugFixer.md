...
Analyze and eliminate a defect; write a regression test; report. **Do not run retrospective yourself** — that's the main agent's job via the `bug-retro` skill after the PO receives the report.
